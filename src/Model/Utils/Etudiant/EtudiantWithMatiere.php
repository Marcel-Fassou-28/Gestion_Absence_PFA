 ...
 * @property int $nomMatiere
 */
class EtudiantWithMatiere {
    /**
     * @var int $idEtudiant
     */
    private $idEtudiant;
     ...
     * Constructeur
     */
    /*public function __construct(int $idEtudiant, string $nom, string $prenom, string $cne, string $cinEtudiant, string $email, int $idClasse, string $nomMatiere, string $nomClasse) {
