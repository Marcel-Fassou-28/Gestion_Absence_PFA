...
$listeEtudiant = $professeurTable->studentCurrent($cinProf);

$filiere = $professeurTable->getCurrentFiliere($cinProf);
$matiere = $professeurTable->getCurrentMatiere($cinProf);
$classe = $professeurTable->getCurrentClasse($cinProf)->getNomClasse();
$creneau = $professeurTable->getCreneau($cinProf);

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    $arrayAbsence = $_POST['arrayCheckbox'] ?? [];
    $listeEtudiant = $professeurTable->findStudentByClass($classe);
