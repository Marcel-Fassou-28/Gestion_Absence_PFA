            ...
            <tbody>
                <?php foreach ($listeProf as $row) { ?>
                    <tr>
                        ...
                        <td class="btns">
                            <a href="<?= $router->url('modifier-professeur') . '?listprof=1&p=0&modifier=1&cin=' . $row->getCIN() ?>"
                                class="btn1">Modifier</a>
                            <a href="<?= $router->url('supprimer-professeur') . '?listprof=1&p=0&modifier=1&cin=' . $row->getCIN() ?>"
